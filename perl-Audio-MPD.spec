...
Summary(pl.UTF-8):	Audio::MPD to moduł perla do wtorzenia apikacji dla MPD
Name:		perl-Audio-MPD
Version:	0.18.1
Release:	1
# same as perl
...
Audio::MPD to moduł perla do tworzenia klientow i innych skryptow
kontrolujących dla serwera MPD (Music Player Daemon)
